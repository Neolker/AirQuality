...
| https://air-quality-b.tes-t.cz/api/device/update/        | POST   | {`device_id`, `name`, `location`, `co2_green`, `co2_yellow`, `co2_red`}                                   | {`status`, `error`, {device_data} }                             | Aktualizace zařízení přihlášeného uživatele |
